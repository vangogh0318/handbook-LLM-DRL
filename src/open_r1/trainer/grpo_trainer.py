...
class GRPOTrainer(Trainer):
    ...
    def _generate_and_score_completions(
        ...
        sum_grouped_rewards = rlhf_reward.view(-1, self.num_generations).sum(dim=1)
        sum_grouped_rewards = sum_grouped_rewards.repeat_interleave(self.num_generations, dim=0)
        baseline = (sum_grouped_rewards-rlhf_reward)/(self.num_generations-1)
